...
import Waxberry from './waxberry/waxberry';

import {message, Select, Input, Upload, Switch, Spin, Cascader} from 'antd';
...
class App extends Component {
    ...
    render() {
        const { step,waxberryExtendObj,waxberryObj,fileList,showWaxberryModal,iconSpinning1,iconSpinning2,detailSpinning,agentMenuList,modelParamConfig } = this.state;
        const { t } = this.props;
        ...
        return (
            <div className="small-model-create_step right_bj">
                ...
                <div className="step-content">
                    ...
                    {step === 3 && <Waxberry waxberryObj={waxberryObj} waxberryExtendObj={waxberryExtendObj} modelParamConfig={modelParamConfig} next={this.next3}/> }
